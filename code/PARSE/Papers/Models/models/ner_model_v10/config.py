...
class Config(object):
    def __init__(self, mode):
        ...
        if mode == 'ssh':
            ...
            self.predict_dict_output_path = "/home/users/u7274475/askg/anu-scholarly-kg/src/Papers/ASKG_Paper_Dataset/NER_result"
            ...
            self.predict_model_path = "/home/users/u7274475/askg/anu-scholarly-kg/src/Papers/Models/models/trained_model/model_0.9168_0.9407_0.9264_3280.bin"
            self.askg_cs_papaer_path = "/home/users/u7274475/askg/anu-scholarly-kg/src/Papers/ASKG_Paper_Dataset/BIO_Format/"
        else:
            ...
            self.askg_cs_papaer_path = "../../../ASKG_Paper_Dataset/BIO_Format/"
        ...
        self.predict_model = "SciBERT"
        self.optimizer = "BertAdam"  # AdamW
        self.do_pgd = False
        self.general_learning_rate = 5e-4
