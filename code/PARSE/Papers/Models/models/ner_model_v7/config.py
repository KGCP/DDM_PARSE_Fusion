...
class Config(object):
    def __init__(self, mode):
        ...
        self.pretrained_model = 'ROBERTA' #ALBERT, ROBERTA, BERT-base, SciBERT
        ...
        if self.pretrained_model == 'BERT-base':
            ...
            if mode == "ssh":
                self.model_dir = "/home/users/u7274475/askg/anu-scholarly-kg/src/Papers/Models/models/pre_trained_models/deberta"
            else:
