...
if torch.cuda.is_available() or config.pretrained_model != "None":
...
if __name__ == '__main__':
    ...
    if mode == "ssh":
        train_dataloader = DataLoader(config.batch_size,
                                      data_file=config.processed_data + 'train_merged_BIO.csv',
                                      tokenizer=tokenizer, max_seq_length=config.max_sequence_length, pretrained_model=config.pretrained_model)
        val_dataloader = DataLoader(config.batch_size, data_file=config.processed_data + 'test_merged_BIO.csv',
        ...
        train_dataloader = DataLoader(config.batch_size,
                                      data_file=config.processed_data + 'title_all.csv',
                                      tokenizer=tokenizer, max_seq_length=config.max_sequence_length, pretrained_model=config.pretrained_model)
