...
def main(input_dir, output_dir):
    ...
    # Find input files
    md_file = os.path.join(input_dir, 'A_Pipeline_for_Analysing_Grant_Applications.md')
    ...
    # Generate XML output
    xml_output = os.path.join(output_dir, f"{base_name}_ddm.xml")
    generate_xml(doc, xml_output)
...
if __name__ == "__main__":
    input_dir = r"D:\testpycharm\anu-scholarly-kg\DDM\Marker\A_Pipeline_for_Analysing_Grant_Applications"
    output_dir = r"D:\testpycharm\anu-scholarly-kg\DDM\Marker\output"
